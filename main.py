...
import os
os.environ['TORCHAUDIO_BACKEND'] = 'librosa'
...
class UrbanSoundDataset(Dataset):
    ...
    def _get_audio_sample_path(self, index):  #This code takes the audio path and data in the csv file found in the  PREMADE DATASET (We wanna make our own)

        fold = self.annotations.iloc[index, 7]
    ...
    def _right_pad_if_necessary(self, signal):
        ...
        if length_signal < self.num_samples:
            ...
            last_dim_padding = (0, num_missing_samples) # (Left padding, right padding)
